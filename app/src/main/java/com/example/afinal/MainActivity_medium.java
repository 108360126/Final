...
public class MainActivity_medium extends AppCompatActivity {

    private Button button4,button5;
    public int TV_case = 0,counter;
    private ImageView Image;
    private void showToast1(){
        Toast toast = new Toast(MainActivity_medium.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder dialog = new AlertDialog.Builder(MainActivity_medium.this);
                ...
                dialog.setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if(text1.getCurrentTextColor()== Color.GREEN&&text2.getCurrentTextColor()==Color.GREEN&&text3.getCurrentTextColor()==Color.GREEN){
                            showToast1();
                            startActivityForResult(new Intent(MainActivity_medium.this, MainActivity_workout.class),
                                    1);
                        }else{
                            showToast2();
                            startActivityForResult(new Intent(MainActivity_medium.this, MainActivity_workout.class),
